...
function App() {
  ...
  return (
    ...
    <div className='Home'>
      ...
      <div className='Navigation'><a href='#'>ABOUT</a><a href='#'>SERVICES</a><a href='#'>CONTACT</a></div>
    ...
    <div className='OurServices'>
      ...
      <div className='DiamondBox'></div>
      <div className='DiamondBox1'></div>
      <div className='DiamondBox2'></div>
      <div className='DiamondBox3'></div>
      <div className='DiamondBox4'></div>
        <div className='Icons'>
          <div>
          <div className='DiamondIcon1'><i class="fa-sharp fa-solid fa-clock"></i><i class="fa-solid fa-computer"></i></div>
          <div className='DiamondIcon2'><i class="fa-solid fa-truck-medical"></i></div>
          <div className='DiamondIcon3'><i class="fa-solid fa-prescription-bottle-medical"></i><i class="fa-solid fa-user-doctor"></i></div>
          </div>
        </div>
        ...
        <div className='ServicesInfo'>
          ...
          <p>
             Elit aute tempor adipisicing sunt proident quis id deserunt aliquip cupidatat irure ipsum. Reprehenderit consequat ullamco cillum aliquip cupidatat ipsum est eiusmod nisi dolore do proident sint. Qui anim proident qui occaecat Lorem excepteur amet occaecat est.
              ...
              Officia nostrud et magna minim ullamco ullamco duis id excepteur et Lorem ipsum. Quis cupidatat veniam ad amet et. Culpa do excepteur labore sunt excepteur cupidatat cillum minim. Excepteur qui ut ullamco exercitation nisi commodo ad laborum dolore occaecat proident aliqua anim veniam. Officia ullamco minim in fugiat aliqua aliquip excepteur quis sint.
              Commodo in cillum enim nisi anim occaecat adipisicing amet veniam laboris. Ipsum occaecat eiusmod nostrud dolor officia enim laborum enim laborum labore anim eu ipsum aliquip. Labore occaecat laborum et labore esse adipisicing culpa occaecat ullamco consequat reprehenderit pariatur nisi eiusmod. Ut excepteur elit nisi enim. 
              In nostrud incididunt Lorem consectetur ullamco reprehenderit est duis enim adipisicing laborum. Irure reprehenderit laborum tempor nostrud ex excepteur incididunt ut mollit sunt. Magna cupidatat aliqua anim magna est ut.<br></br>
    ...
    <div className='WhoUseMobmed'>
      ...
      <div className='ServiceProviders'>
        <div>
          ...
          <p className='ServiceProvidersText'>Duis aliqua pariatur ut enim aliqua proident enim officia do ex tempor cillum amet ullamco.</p>
        </div>
